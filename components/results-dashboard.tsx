    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Key findings and statistics from your donor data</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    {Math.round((emailUpdates / totalDonors) * 100)}% of your donors have updated email addresses
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600 mt-0.5" />
                  <span>
                    {Math.round((worthUpdates / totalDonors) * 100)}% of your donors have increased in estimated worth
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600 mt-0.5" />
                  <span>The average estimated worth has increased by approximately 35%</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600 mt-0.5" />
                  <span>3 donors have moved to new companies or organizations</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600 mt-0.5" />
                  <span>2 donors have been promoted to leadership positions</span>
                </li>
              </ul>
              ...
              <div className="pt-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Update your email campaign to use the new contact information</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <BarChart3 className="h-5 w-5 text-blue-600 mt-0.5" />
                    <span>Consider a targeted campaign for donors with increased worth</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <BarChart3 className="h-5 w-5 text-blue-600 mt-0.5" />
                    <span>Schedule regular data cleaning every 3-6 months</span>
                  </li>
                </ul>
              </div>
            </div>
